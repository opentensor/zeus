...
class NetworkGraph extends React.Component {
    ...
    highChartsRender() {
        Highcharts.chart({
          chart: {
              type: 'spline',
              renderTo: 'network-line-charts'
          },
          credits: false,
          title: {
              text: 'Number of active peers'
          },
          subtitle: {
              text: 'Irregular time data on Bittensor active peers'
          },
          xAxis: {
              type: 'datetime',
